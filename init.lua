...
- minimap on right
- i hate closing buffers/windows
...
-- Make relativ line numbers default
vim.opt.number = true
...
vim.keymap.set('n', '<leader>vv', ':<C-u>vsplit<CR>', { desc = 'Create vertical split' })
vim.keymap.set('n', '<leader>vx', ':<C-u>split<CR>', { desc = 'Create horizontal split' })
...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    dependencies = {
      ...
      -- NOTE: `opts = {}` is the same as calling `require('fidget').setup({})` and forces plugin load
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Jump to the declation of the word under your cursor.
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      -- Many themes have several different styles, and you could load any other.
